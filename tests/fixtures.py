...
@pytest.fixture
def create_share_token(user):
    """
    A fixture that creates a :obj:`ShareToken` instance using the
    :obj:`ShareTokenFactory`.  Any data that is not explicitly provided will
    be randomly generated by the factory.

    Usage:
    -----
    >>> def test_share_token(create_share_token):
    >>>     token = create_share_token(instance=budget)
    ...
    def inner(*args, **kwargs):
        ...
        return ShareTokenFactory(*args, **kwargs)
    return inner
