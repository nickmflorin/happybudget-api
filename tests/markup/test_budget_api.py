...
@pytest.mark.freeze_time('2020-01-01')
def test_update_budget_markup_children(api_client, user, create_budget,
        create_markup, create_budget_account, models, create_budget_subaccounts):
    budget = create_budget()
    markups = [
    ...
    accounts = [
        create_budget_account(parent=budget, markups=[markups[2]]),
        create_budget_account(parent=budget, markups=[markups[2]]),
        create_budget_account(parent=budget, markups=[markups[2]])
    ]
    subaccount_sets = [
...
@pytest.mark.freeze_time('2020-01-01')
def test_update_account_markup_children(api_client, user, create_budget,
        create_markup, create_budget_account, models, create_budget_subaccount):
    budget = create_budget()
    account = create_budget_account(parent=budget)
    markups = [
...
@pytest.mark.freeze_time('2020-01-01')
def test_update_subaccount_markup_children(api_client, user, create_budget,
        create_markup, create_budget_account, models, create_budget_subaccount):
    budget = create_budget()
    account = create_budget_account(parent=budget)
    subaccount = create_budget_subaccount(parent=account)
...
@pytest.mark.freeze_time('2020-01-01')
def test_update_account_flat_markup_rate(api_client, user, create_budget, models,
        create_budget_account, create_markup, create_budget_subaccounts):
    budget = create_budget()
    markups = [
        create_markup(parent=budget, flat=True, rate=20),
        create_markup(parent=budget, flat=True, rate=30)
...
@pytest.mark.freeze_time('2020-01-01')
def test_update_account_percent_markup_rate(api_client, user, create_budget,
        models, create_budget_account, create_markup, create_budget_subaccounts):
    budget = create_budget()
    markups = [
        create_markup(parent=budget, percent=True, rate=0.5),
        create_markup(parent=budget, flat=True, rate=30)
...
@pytest.mark.freeze_time('2020-01-01')
def test_remove_budget_percent_markup_children(api_client, user, create_markup,
...
@pytest.mark.freeze_time('2020-01-01')
def test_add_budget_percent_markup_children(api_client, user, create_markup,
        models, create_budget_account, create_budget, create_budget_subaccounts):
    budget = create_budget()
    account = create_budget_account(parent=budget)
    create_budget_subaccounts(parent=account, quantity=1, rate=10, count=2)
...
def test_add_subaccount_percent_markup_children(api_client, user, create_markup,
        models, create_budget_account, create_budget, create_budget_subaccount,
        create_budget_subaccounts):
    budget = create_budget()
    account = create_budget_account(parent=budget)
    subaccount = create_budget_subaccount(parent=account)
    markup = create_markup(parent=subaccount, percent=True, rate=0.50)
    children_subaccounts = create_budget_subaccounts(
        parent=subaccount,
        quantity=1,
        rate=10,
        count=2
...
def test_update_budget_markup_child_not_same_parent(api_client, user,
...
def test_delete_budget_markup(api_client, user, create_budget, models,
        create_markup):
    budget = create_budget()
    markup = create_markup(parent=budget, percent=True)
...
def test_delete_account_markup(api_client, user, create_budget,
