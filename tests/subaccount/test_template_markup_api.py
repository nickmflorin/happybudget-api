...
@pytest.mark.freeze_time('2020-01-01')
def test_create_template_subaccount_subaccount_markup(api_client, user,
...
def test_create_template_subaccount_subaccount_markup_invalid_child(api_client,
    ...
    with signals.disable():
        ...
        account = create_template_account(parent=template)
        subaccount = create_template_subaccount(parent=account)
        another_subaccount = create_template_subaccount(parent=account)
        child_subaccount = create_template_subaccount(parent=another_subaccount)
...
def test_bulk_delete_subaccount_markups(api_client, user, create_template,
        models, create_template_account, create_markup,
        create_template_subaccount):
    template = create_template()
    account = create_template_account(parent=template)
    parent_subaccount = create_template_subaccount(parent=account)
    markups = [
        create_markup(
