    ...
    assert response.json()['data'] == [
        {
            ...
            "name": first_level_subaccounts[0].name,
            "in_search_path": True,
            "children": [
                {
                    ...
                    "identifier": "Sub Account A-A-A",
                    "type": "subaccount",
                    "name": second_level_subaccounts[0].name,
        ...
        },
        {
            ...
            "name": first_level_subaccounts[1].name,
            "in_search_path": True,
            "children": [
                {
                    ...
                    "identifier": "Sub Account A-B-A",
                    "type": "subaccount",
                    "name": second_level_subaccounts[1].name,
                ...
                },
                {
                    ...
                    "identifier": "Sub Account A-B-B",
                    "type": "subaccount",
                    "name": second_level_subaccounts[2].name,
        ...
        },
        {
            ...
            "name": first_level_subaccounts[2].name,
            "in_search_path": True,
            "children": [
                {
                    ...
                    "identifier": "Sub Account A-C-A",
                    "type": "subaccount",
                    "name": second_level_subaccounts[3].name,
                ...
                },
                {
                    ...
                    "identifier": "Sub Account A-C-B",
                    "type": "subaccount",
                    "name": second_level_subaccounts[4].name,
                ...
                },
                {
                    ...
                    "identifier": "Sub Account A-C-C",
                    "type": "subaccount",
                    "name": second_level_subaccounts[5].name,
        ...
        },
        {
            ...
            "name": first_level_subaccounts[3].name,
            "in_search_path": True,
            "children": []
        }
    ]
