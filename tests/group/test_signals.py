...
def test_account_group_parent_constraint(budget_f, create_group):
...
def test_subaccount_group_parent_constraint(budget_f, create_group):
    budget = budget_f.create_budget()
...
def test_remove_account_from_group_group_deleted(budget_f, models, create_group):
    budget = budget_f.create_budget()
    group = create_group(parent=budget)
...
def test_remove_account_from_group_group_not_deleted(budget_f, create_group,
        models):
    budget = budget_f.create_budget()
    group = create_group(parent=budget)
    account = budget_f.create_account(parent=budget, group=group)
...
def test_remove_subaccount_from_group_group_deleted(budget_f, create_group,
        models):
    budget = budget_f.create_budget()
    account = budget_f.create_account(parent=budget)
    group = create_group(parent=account)
...
def test_remove_subaccount_from_group_group_not_deleted(budget_f, models,
        create_group):
    budget = budget_f.create_budget()
    account = budget_f.create_account(parent=budget)
    group = create_group(parent=account)
