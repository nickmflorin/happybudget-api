...
def test_create_account_flat_markup_without_rate(api_client, user, budget_f,
        models):
    budget = budget_f.create_budget()
    account = budget_f.create_account(parent=budget)
    subaccounts = budget_f.create_subaccount(
...
def test_create_account_percent_markup_without_rate(api_client, user, budget_f,
        models):
    budget = budget_f.create_budget()
    account = budget_f.create_account(parent=budget)
    subaccounts = budget_f.create_subaccount(
...
def test_bulk_delete_account_markups(api_client, user, models, f, budget_f):
    budget = budget_f.create_budget()
    account = budget_f.create_account(parent=budget)
    markups = [
        f.create_markup(parent=account, unit=models.Markup.UNITS.flat, rate=100),
        f.create_markup(parent=account, unit=models.Markup.UNITS.flat, rate=100),
        f.create_markup(
            parent=account,
            unit=models.Markup.UNITS.percent,
