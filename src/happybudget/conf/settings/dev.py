...
APP_DOMAIN = 'devapi.happybudget.io'  # Post Copyright Infringement
APP_URL = 'https://%s' % APP_DOMAIN
FRONTEND_URL = "https://dev.happybudget.io/"  # Post Copyright Infringement

CSRF_TRUSTED_ORIGINS = [
    'https://dev.happybudget.io',  # Post Copyright Infringement
    'https://devapi.happybudget.io',  # Post Copyright Infringement
]

ALLOWED_HOSTS = ['devapi.happybudget.io']  # Post Copyright Infringement
